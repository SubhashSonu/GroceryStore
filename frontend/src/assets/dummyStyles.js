...
export const recipePageStyles = {
  page: "min-h-screen bg-gray-50 p-4 sm:p-8",
  header: "text-3xl font-bold text-emerald-700 mb-8 text-center",
  recipeCard: "bg-white shadow-lg rounded-lg p-6 mb-8 max-w-4xl mx-auto transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl",
  recipeImage: "w-full h-64 object-cover rounded-lg mb-4",
  recipeTitle: "text-2xl font-semibold text-gray-800 mb-2",
  sectionTitle: "text-xl font-semibold text-emerald-600 mt-4 mb-2",
  ingredientList: "list-disc pl-6 space-y-1 text-gray-700",
  stepList: "list-decimal pl-6 space-y-2 text-gray-700",
};
