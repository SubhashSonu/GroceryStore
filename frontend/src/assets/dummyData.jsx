...
export const recipes = [
  ...
  },
  {
    id: 2,
    name: "Avocado Toast",
    description: "Healthy breakfast with smashed avocado on multigrain bread.",
  ...
  },
  {
    id: 3,
    name: "Chicken Curry",
    description: "Spicy Indian chicken curry served with steamed rice.",
    ...
    steps: [
      ...
      "Add ginger-garlic paste and sauté 2 mins.",
      "Add chicken pieces and brown.",
      "Add tomato puree and curry powder, cook 5 mins.",
