    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className={styles.card}>
            ...
            <button
              ...
              className={`${styles.button} ${isSubmitting ? styles.disabledButton : styles.submitButton} mt-6`}
            >
              {isSubmitting ? (
        ...
        <div className={styles.deliveryInfo}>
          ...
          <p>
            We deliver within 30-45 minutes. Order placed after 9PM will be
            delviered to next morning.
          </p>
        </div>
      </div>
    </div>
