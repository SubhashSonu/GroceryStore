...
const CartPage = () => {
  ...
  // subtotal
  const subtotal = cart.reduce((sum,item)=> { return sum + getItemPrice(item)*item.quantity},0);
      ...
      <div className={cartStyles.pageContainer}>
        <div className={cartStyles.maxContainer}>
          ...
          <div className={cartStyles.emptyCartContainer}>
            <div className={cartStyles.emptyCartButton}><FaShoppingCart/></div>
                ...
                <div key={id} className={cartStyles.cartItemCard}>
                  ...
                  <div className={cartStyles.cartItemQuantityContainer}>
                    ...
                    <span className={cartStyles.cartItemQuantity}>
                     ...
                     <button onClick={()=> removeFromCart(id)} className={cartStyles.cartItemRemoveButton}>
          ...
          <div className={cartStyles.orderSummaryCard}>
            ...
            <div className="space-y-4 text-sm sm:text-base">
              ...
              <div className={cartStyles.orderSummaryRow}>
                ...
                <span className={cartStyles.orderSummaryValue}>₹{(subtotal*0.05).toFixed(2)}</span>
              </div>
              ...
              <div className={cartStyles.orderSummaryTotalRow}>
                ...
                <span className={cartStyles.orderSummaryTotalValue}>₹{(subtotal*1.05).toFixed(2)}</span>
              </div>
