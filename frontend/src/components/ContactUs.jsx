...
import { FaCheck, FaComment, FaEnvelope, FaPaperPlane, FaPhone, FaTag, FaUikit, FaUser } from 'react-icons/fa';
                    ...
                    <div className={contactStyles.formField}>
                      ...
                      <div className={contactStyles.formField}>
                        <div className={contactStyles.inputContainer}>
                            ...
                            <input type="email" id='email' name='email' value={formData.email} onChange={handleChange} className={contactStyles.formInput} placeholder='johndoe@emample.com' required/>
