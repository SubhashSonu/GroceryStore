        ...
        <div className={loginStyles.loginCard}>
          ...
          <form onSubmit={handleSubmit} className={loginStyles.form}>
             ...
             <div className={loginStyles.inputContainer}>
                   ...
                   <button type="button" onClick={() => setShowPassword((toggle)=> !toggle)} className={loginStyles.toggleButton} aria-label={showPassword ? 'Hide password' :'Show password'}>
             ...
             <div className={loginStyles.rememberContainer}>
                <label className={loginStyles.rememberLabel}>
                  ...
                  onChange={handleChange} className={loginStyles.rememberCheckbox} required/>
                  Remember me
                </label>
